...
# Made with love by Amar Kumar
# install some prerequisite library
'''
- OS
- openai
- customtkinter
...
def generate():
    ...
    difficulty=difficulty_vlaue.get()
    ...
    if checkbox2.get():
        prompt+="The project sholud include an API. "
...
root.title("Notion Agent")

ctk.set_appearance_mode("dark")

title_label=ctk.CTkLabel(root, text="Welcome to Notion Agent!",
                         font=ctk.CTkFont(size=20, weight="bold")
                         )
title_label.pack(padx=5, pady=(30,10))

title_label=ctk.CTkLabel(root, text="A Project Idea Generator",
...
language_dropdown=ctk.CTkComboBox(
    language_frame, values=["Python", "Java", "C++", "JavaScript", "Golang", "React.js", "AWS"]
)
...
difficulty_vlaue=ctk.StringVar(value="Easy")
radiobutton1=ctk.CTkRadioButton(
    difficulty_frame, text="Easy", variable=difficulty_vlaue, value="Easy"
)

radiobutton1.pack(side="left", padx=(20,10), pady=10)

radiobutton2=ctk.CTkRadioButton(
    difficulty_frame, text="Medium", variable=difficulty_vlaue, value="Medium"
)

radiobutton2.pack(side="left", padx=10, pady=10)

radiobutton3=ctk.CTkRadioButton(
    difficulty_frame, text="Hard", variable=difficulty_vlaue, value="Hard"
)
...
title_label=ctk.CTkLabel(root, text="# Made with ❤️ by Amar Kumar",
